...
import { FaMousePointer, FaDollarSign, FaHouseUser } from "react-icons/fa";
import  home1  from "../Pagecomponents/images/home 1.png";
import  home2  from "../Pagecomponents/images/home 2.png";
import  home3  from "../Pagecomponents/images/home3.png";
...
const PropertyCards = () => {
  return (
    <Container className="py-5">
      <Row className="g-4">
        <Col md={4}>
          <Card className="text-center" style={{ backgroundColor: "#ffeef0" , height: "400px"}}>
            <Card.Body>
            <svg class="text-dark-emphasis my-3 mt-sm-0" xmlns="http://www.w3.org/2000/svg"
              ...
              <Button variant="dark">Find a home</Button>
            </Card.Body>
            <Card.Img
              variant="bottom"
              src={home1}
        ...
        <Col md={4}>
          <Card className="text-center" style={{ backgroundColor: "#3D7A81" , height: "400px"}}>
            <Card.Body>
            <svg class="text-white my-3 mt-sm-0" xmlns="http://www.w3.org/2000/svg" width="48"
              ...
              <Button variant="dark">Place an ad</Button>
            </Card.Body>
            <Card.Img
              variant="bottom"
              src={home2}
        ...
        <Col md={4}>
          <Card className="text-center" style={{ backgroundColor: "#fff5e5" , height: "400px"}}>
            <Card.Body>
            <svg class="text-dark-emphasis my-3 mt-sm-0" xmlns="http://www.w3.org/2000/svg"
                                    width="48" height="48" fill="black">
                                    <path
              ...
              <Button variant="dark">Find a rental</Button>
            </Card.Body>
            <Card.Img
              variant="bottom"
              src={home3}
